                    ...
                    <div className="signup-div">
                        <div className="signup-card">
                            ...
                            <p className="signup-with font-generic">
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M9.34958 17.8005C11.6581 17.8005 13.5935 17.0349 15.0081 15.7291L12.2449 13.5838C11.4793 14.0968 10.4999 14.3999 9.34958 14.3999C7.12269 14.3999 5.2378 12.8959 4.56546 10.875H1.70898V13.0902C3.11585 15.8845 6.0073 17.8005 9.34958 17.8005Z" fill="#34A853"/>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M4.56667 10.8749C4.39567 10.3619 4.29851 9.81389 4.29851 9.25037C4.29851 8.68685 4.39567 8.13887 4.56667 7.62587V5.41064H1.71019C1.13112 6.56489 0.800781 7.87071 0.800781 9.25037C0.800781 10.63 1.13112 11.9358 1.71019 13.0901L4.56667 10.8749Z" fill="#FBBC05"/>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M9.34957 4.10076C10.6049 4.10076 11.7319 4.53215 12.618 5.37938L15.0703 2.92708C13.5896 1.54742 11.6542 0.700195 9.34957 0.700195C6.0073 0.700195 3.11585 2.61617 1.70898 5.41047L4.56546 7.6257C5.2378 5.60479 7.12269 4.10076 9.34957 4.10076Z" fill="#EA4335"/>
                                </g>
                                <defs>
                                <clipPath id="clip0_264_8297">
                                <rect width="17.1" height="17.1" fill="white" transform="translate(0.800781 0.700195)"/>
                                </clipPath>
                                </defs>
                                </svg>
                                Singup with Google
