  ...
  return (
    ...
    <section id='OurTeam'>
       ...
       <div className="TeamCore">
          <p className="TeamName">Meet Our <span>Team.</span></p>
        ...
        <div className="TeamCreative">
          <p className="TeamName">Team <span>Technical</span></p>
          <p className="TeamNameSubTitle">
        ...
        {/* Creative */}
        <div className="TeamCreative">
          <p className="TeamName">Team <span>Creative</span></p>
          <p className="TeamNameSubTitle">
        ...
        {/* Marketing */}
        <div className="TeamCreative">
          <p className="TeamName">Team <span>Marketing</span></p>
          <p className="TeamNameSubTitle">
        ...
        {/* Operations */}
        <div className="TeamCreative">
          <p className="TeamName">Team <span>Operations</span></p>
          <p className="TeamNameSubTitle">
        ...
        {/* Alumni */}
        <div className="TeamCreative">
          <p className="TeamName">Our <span>Alumni</span></p>
          <p className="TeamNameSubTitle">
            {/* Those who help us plan, strategize, commemorate, organize and
          operate FED's initiatives! */}
          </p>
