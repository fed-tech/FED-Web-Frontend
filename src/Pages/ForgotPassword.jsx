...
function ForgotPassword() {
    ...
    const handleSendOtp = async (e)=>{
      ...
      try{
        const res = await axios.post('http://localhost:5000/auth/sendotp',{email});
    ...
    const handleConfirmOtp = async (e)=>{
      ...
      try{
        const res =  await axios.post('http://localhost:5000/auth/validate',{email,otp});
      ...
      <div className="inside">
        ...
        <div className="whitebox">
          <div className="hellopart">
            <p className="welc">Forgot Password</p>
          </div>
          <div className="user">
            <input
              type="text"
          ...
          {!showBtn && <button className="logtwo" onClick={handleSendOtp}>
            Send OTP
          </button>}
          {showBtn&&<button className="logtwo" onClick={handleConfirmOtp}>
            Verify OTP
          </button>}
